...
echo -e "\n[7/7] Downloading averaged_perceptron_tagger..."
...
echo "Test in Python with:"
echo "  python3 -c \"import nltk; print(nltk.word_tokenize('Test sentence.'))\""