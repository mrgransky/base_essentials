...
# srun -J intrtv_cpuTEST --account=project_2009043 --partition=test --time=00-00:15:00 --mem=180G --ntasks=1 --cpus-per-task=8 --pty /bin/bash -i
# srun -J small_interactive_cpu --account=project_2009043 --partition=small --time=03-00:00:00 --mem=373G --ntasks=1 --cpus-per-task=1 --pty /bin/bash -i
